...
<body>
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Settings</p>
                            ...
                            <td width="15%">
                                ...
                                $adminrow = $database->query("select  * from  admin;");
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="?action=edit&email=<?php echo $useremail ?>&error=0" class="non-style-link">
                            ...
                            <tr>
                            <td style="width: 25%;">
                                    <a href="?action=view&email=<?php echo $useremail ?>" class="non-style-link">
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            $nameget=$_GET["name"];
            echo '
            <div email="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Are you sure?</h2>
                        ...
                        <a href="delete-doctor.php?email='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            $sqlmain= "select * from admin where aemail='$email'";
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Admin Details.</p>                                    
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
